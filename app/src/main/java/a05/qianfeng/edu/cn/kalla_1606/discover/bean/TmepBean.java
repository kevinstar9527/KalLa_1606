...
public class TmepBean {
    ...
    public static TmepBean objectFromData(String str) {

        return new Gson().fromJson(str, TmepBean.class);
    }

    public static List<TmepBean> arrayTmepBeanFromData(String str) {

        java.lang.reflect.Type listType = new TypeToken<ArrayList<TmepBean>>() {
        }.getType();
