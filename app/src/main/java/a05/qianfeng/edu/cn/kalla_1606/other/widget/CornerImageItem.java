 ...
 */
public class CornerImageItem extends RelativeLayout {

    private ImageView iv;
    private TextView title;
    private TextView content;

    public CornerImageItem(Context context, Special special){
    ...
    public void setSpecial(Special special){
       ...
       // Log.e("msg",special.getLikedNum());
        content.setText(String.valueOf(special.getLikedNum()));

    }
    public CornerImageItem(Context context, AttributeSet set){
