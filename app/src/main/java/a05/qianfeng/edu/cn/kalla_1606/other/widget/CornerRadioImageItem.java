 ...
 */
public class CornerRadioImageItem extends RelativeLayout {

    private ImageView iv;
    private TextView title;
    private TextView content;

    public CornerRadioImageItem(Context context, RadioInner special){
    ...
    /*设置内容*/
    public void setSpecial(RadioInner special){
    ...
    public CornerRadioImageItem(Context context, AttributeSet set){
